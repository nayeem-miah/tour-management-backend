...
const initPayment = (bookingId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!payment) {
        throw new appError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, "Payment not found, You have not book tour");
    }
    ;
...
const successPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!updatedBooking) {
            throw new appError_1.default(401, "booking is not found");
        }
        //  PDF Buffer
        const invoiceData = {
        ...
        // upload pdf
        const cloudinaryResult = yield (0, cloudinary_config_1.uploadBufferCloudinary)(bufferPdf, "invoice");
        if (!cloudinaryResult) {
...
const cancelPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    session.startTransaction();
    try {
        const updatedPayment = yield payment_model_1.Payment.findOneAndUpdate({ transactionId: query.transactionId }, { status: payment_interface_1.PAYMENT_STATUS.CANALED }, { runValidators: true, session });
        // booking status update
